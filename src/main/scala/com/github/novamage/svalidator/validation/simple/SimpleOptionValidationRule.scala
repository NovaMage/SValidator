...
class SimpleOptionValidationRule[A, B](lazyPropertyValue: => Option[B], ruleExpression: B => Boolean, fieldName: String, errorMessage: (String, B) => String, conditionedValidation: A => Boolean) extends IValidationRule[A] {
