...
import com.github.novamage.svalidator.binding.binders.{JsonTypedBinder, TypedBinder, special}
...
class EnumerationBinderSpecs extends Observes {
  ...
  describe("when binding an enumeration value using the enumeration binder") {
    ...
    describe("and the values map method of binding is used") {
      ...
      val sut: TypedBinder[Any] = new EnumerationBinder(testedTypeTag.tpe, testedTypeTag.mirror, BindingConfig.defaultConfig)
    ...
    describe("and the json method of binding is used") {
      ...
      val sut: JsonTypedBinder[Any] = new EnumerationBinder(testedTypeTag.tpe, testedTypeTag.mirror, BindingConfig.defaultConfig)

      describe("and the field name is not present in the json") {
      ...
      describe("and the field name is present in the json") {

        describe("and a value is passed in") {


          describe("and the passed in value is not a valid integer") {
